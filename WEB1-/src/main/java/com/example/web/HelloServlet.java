...
//                httpSession.removeAttribute("userName");
        ...
        if(page.equalsIgnoreCase("order")){
            ...
            List<CartItems> cartItems = objectMapper.readValue(cartJson, new TypeReference<List<CartItems>>() {});
            try {
                new UserService().insertCartItem(cartItems, req.getSession());
            } catch (SQLException e) {
        ...
        if (page.equalsIgnoreCase("cartItems")){
            ...
            RequestDispatcher requestDispatcher  = req.getRequestDispatcher("commonModals.jsp");
            requestDispatcher.forward(req, resp);
        }
