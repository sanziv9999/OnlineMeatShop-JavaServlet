...
<nav class="navbar navbar-expand-lg navbar-dark custom-bg" >
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto login">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="user?page=cartItems"><i class="fa fa-shopping-cart" style="font-size:20px"></i><span class="ml-0 cart-items">()</span></a>
                </li>
                <li class="nav-item">
